<?php
// source: C:\web\www\learn.local\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7378908461', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb29ba1f2040_head')) { function _lb29ba1f2040_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7737b6bd1b_scripts')) { function _lb7737b6bd1b_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
